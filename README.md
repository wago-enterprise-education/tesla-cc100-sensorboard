...
## Überblick
Der WAGO CC100 Sensorboard Workshop demonstriert die Anbindung eines [HC-SR04 Ultraschallsensors](https://www.reichelt.de/de/de/shop/produkt/entwicklerboards_-_ultraschall_abstandssensor_hc-sr04-161487) an die [WAGO CC100 Steuerung (751-9301)](https://www.wago.com/de/sps/compact-controller-100/p/751-9301#details) und die Auswertung auf einem WAGO Anzeigemodul. Das 3,3 Volt Signal des Ultraschallsensors wird durch eine [Zusatzplatine](./pcb/) per Modbus an den WAGO CC100 übertragen und über die RS-485 Schnittstelle eingelesen. 

## Verzeichnisstruktur
```
doc/                     Aufgabenstellung und Dokumentation
microconnect485USB/      Zusatzplatine für den Ultraschallsensor
├── pcb/                 PCB-Dokumentation (BOM, Gerber-Files, Positionsdaten)
└── src/                 Board-spezifischer Sourcen
